...
public class UserInterface extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_documentSearchButtonActionPerformed
        output.setText("");
        documentCache = CrawlerEngine.loadDocuments();
    ...
    /*****************************************************************************************
     * METHOD: indextSearchButtonActionPerformed is used to perform action when
     * user click on index search button
     *
    ...
    {//GEN-HEADEREND:event_indexSearchButtonActionPerformed
        output.setText("");
        indexCache = CrawlerEngine.loadTopics();
        keyWord = keyWordField.getText().toLowerCase();
        Label.setText("");
